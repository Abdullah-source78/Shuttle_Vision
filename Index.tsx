      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
          <Card className="border-2 hover:border-primary transition-all duration-200 hover:shadow-lg">
            <CardHeader>
              ...
              <CardDescription className="text-base">
                View all buses in real-time, check available seats, and see estimated arrival times
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Link to="/student">
          ...
          <Card className="border-2 hover:border-secondary transition-all duration-200 hover:shadow-lg">
            <CardHeader>
              <div className="bg-secondary/10 p-3 rounded-xl w-fit mb-3">
                <MapPin className="w-8 h-8 text-secondary" />
              </div>
              <CardTitle className="text-2xl">Driver Portal</CardTitle>
              <CardDescription className="text-base">
                Update your GPS location and available seat count to help students track your bus
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Link to="/driver">
        ...
        <div className="bg-card border border-border rounded-xl p-8 max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-foreground mb-4 text-center">Key Features</h2>
